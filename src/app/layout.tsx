...
export const metadata: Metadata = {
  title: "Coastal Blueprint — Sales Training Program",
  description:
    "A 10-session virtual sales training series built for new advisors at Coastal Wealth. April–June 2026.",
  icons: {
